...
Route::get('/programas/{bloque}/{temporada}', 'FrontController@getProgramasByTemporada');
Route::get('/programas/{bloque}/{temporada}/{content}', 'FrontController@getProgramaByNameContent');
